...
@WebServlet(name = "ServicioListados", urlPatterns = {"/ServicioListados"})
public class ServicioListados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch(listar){
                case "usuarios":
                    out.println(GestorDatos.obtenerInstancia().obtenerTablaUsuarios());
                    break;
                case "votaciones":
                    out.println(GestorDatos.obtenerInstancia().obtenerTablaVotaciones());
                    break;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServicioListados.class.getName()).log(Level.SEVERE, null, ex);
